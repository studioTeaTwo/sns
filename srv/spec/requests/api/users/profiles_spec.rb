...
RSpec.describe "Api::Users::Profiles", type: :request do
  ...
  describe "GET /api/users/:id/profiles" do
    it "works!" do
      get api_profiles_path(view_user), headers: { 'Authorization' => "#{current_user.access_token}" }
      ...
      expect(json['positiveAllergenGroups']).to include('allergenGroupYasai')
